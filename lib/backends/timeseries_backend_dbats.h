...
#ifndef __TIMESERIES_BACKEND_DBATS_H
#define __TIMESERIES_BACKEND_DBATS_H

#include "timeseries_backend.h"

/** @file
 *
 * @brief Header file that exposes the timeseries DBATS backend implementation
 * interface
 *
...
TIMESERIES_BACKEND_GENERATE_PROTOS(dbats)

#endif /* __TIMESERIES_BACKEND_DBATS_H */
